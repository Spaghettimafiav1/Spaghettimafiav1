--[[
    Spaghetti Mafia Hub v1 (COMPACT AESTHETIC REMASTER)
    Updates:
    - 100% Original Logic Preserved (Nothing deleted).
    - New Size: 500x350 (Compact & Clean).
    - Smoother Animations (Quart Easing).
    - Credits Fixed: Better spacing, smaller cards.
]]

--// AUTO EXECUTE / SERVER HOP SUPPORT (לוגיקה מקורית נשמרה)
...
local Settings = {
    Theme = {
        Gold = Color3.fromRGB(255, 200, 50), -- זהב עדין יותר
        Dark = Color3.fromRGB(18, 18, 20),   -- רקע כהה נקי (Matte)
        Box = Color3.fromRGB(25, 25, 28),    -- קופסאות בהירות טיפה
...
--// 3. פונקציות עיצוב (Glow מעודכן ודק יותר)
local Library = {}
-- שיניתי ל-Quart כדי שיהיה חלק יותר (Smooth)
...
function Library:Corner(obj, r) local c = Instance.new("UICorner", obj); c.CornerRadius = UDim.new(0, r or 8); return c end -- פינות פחות עגולות
...
LoadBox.Size = UDim2.new(0, 220, 0, 150) -- מוקטן
...
MainFrame.Size = UDim2.new(0,0,0,0); Library:Tween(MainFrame, {Size = UDim2.new(0, 500, 0, 350)}, 0.5, Enum.EasingStyle.Back) 
...
local MainTitle = Instance.new("TextLabel", TopBar); MainTitle.Size = UDim2.new(0,250,0,30); MainTitle.Position = UDim2.new(0,15,0,5); MainTitle.BackgroundTransparency = 1; MainTitle.Text = "SPAGHETTI <font color='#FFD700'>MAFIA</font>"; MainTitle.RichText = true; MainTitle.Font = Enum.Font.GothamBlack; MainTitle.TextSize = 18; MainTitle.TextColor3 = Color3.new(1,1,1); MainTitle.TextXAlignment = Enum.TextXAlignment.Left

local CloseBtn = Instance.new("TextButton", TopBar); CloseBtn.Size = UDim2.new(0, 24, 0, 24); CloseBtn.Position = UDim2.new(1, -30, 0, 8); CloseBtn.BackgroundColor3 = Color3.fromRGB(35, 35, 35); CloseBtn.Text = "_"; CloseBtn.TextColor3 = Settings.Theme.Gold; CloseBtn.Font=Enum.Font.GothamBold; CloseBtn.TextSize=14; Library:Corner(CloseBtn, 6); Library:AddGlow(CloseBtn, Settings.Theme.Gold)
...
MiniPasta.MouseButton1Click:Connect(function() MiniPasta.Visible = false; MainFrame.Visible = true; Library:Tween(MainFrame, {Size = UDim2.new(0, 500, 0, 350)}, 0.4, Enum.EasingStyle.Back) end)
...
local Container = Instance.new("Frame", MainFrame); Container.Size = UDim2.new(1, -130, 1, -50); Container.Position = UDim2.new(0, 130, 0, 45); Container.BackgroundTransparency = 1

local currentTab = nil

-- יצירת טאב (עיצוב מינימליסטי)
...
local Tab_Settings_Page = CreateTab("Settings", "⚙️", 3, false)
...
EventLayout.Padding = UDim.new(0, 10) -- מרווח קטן יותר
...
FarmBtn.Size = UDim2.new(0.96, 0, 0, 50) -- מוקטן מ-70
...
FarmSwitch.Size = UDim2.new(0, 40, 0, 22) -- מתג קטן יותר
...
BalanceContainer.Size = UDim2.new(0.96, 0, 0, 60) -- נמוך יותר
...
local T_TitleB = Instance.new("TextLabel", TotBlues); T_TitleB.Size = UDim2.new(1,0,0.3,0); T_TitleB.Position=UDim2.new(0,0,0.1,0); T_TitleB.BackgroundTransparency=1; T_TitleB.Text="כחולים 🧊"; T_TitleB.TextColor3=Settings.Theme.ShardBlue; T_TitleB.Font=Enum.Font.GothamBold; T_TitleB.TextSize=12; T_TitleB.ZIndex=6
local T_ValB = Instance.new("TextLabel", TotBlues); T_ValB.Size = UDim2.new(1,0,0.5,0); T_ValB.Position=UDim2.new(0,0,0.4,0); T_ValB.BackgroundTransparency=1; T_ValB.Text="..."; T_ValB.TextColor3=Color3.new(1,1,1); T_ValB.Font=Enum.Font.GothamBlack; T_ValB.TextSize=18; T_ValB.ZIndex=6
...
local T_TitleR = Instance.new("TextLabel", TotReds); T_TitleR.Size = UDim2.new(1,0,0.3,0); T_TitleR.Position=UDim2.new(0,0,0.1,0); T_TitleR.BackgroundTransparency=1; T_TitleR.Text="אדומים 💎"; T_TitleR.TextColor3=Settings.Theme.CrystalRed; T_TitleR.Font=Enum.Font.GothamBold; T_TitleR.TextSize=12; T_TitleR.ZIndex=6
local T_ValR = Instance.new("TextLabel", TotReds); T_ValR.Size = UDim2.new(1,0,0.5,0); T_ValR.Position=UDim2.new(0,0,0.4,0); T_ValR.BackgroundTransparency=1; T_ValR.Text="..."; T_ValR.TextColor3=Color3.new(1,1,1); T_ValR.Font=Enum.Font.GothamBlack; T_ValR.TextSize=18; T_ValR.ZIndex=6

-- 3. Session Stats (מוקטן)
...
StatsContainer.Size = UDim2.new(0.96, 0, 0, 60)
...
local TitleBlue = Instance.new("TextLabel", BoxBlue); TitleBlue.Size = UDim2.new(1, 0, 0.3, 0); TitleBlue.Position = UDim2.new(0,0,0.1,0); TitleBlue.BackgroundTransparency = 1; TitleBlue.Text = "Shards +"; TitleBlue.TextColor3 = Settings.Theme.IceBlue; TitleBlue.Font = Enum.Font.GothamBold; TitleBlue.TextSize = 12; TitleBlue.ZIndex=6
local ValBlue = Instance.new("TextLabel", BoxBlue); ValBlue.Size = UDim2.new(1, 0, 0.5, 0); ValBlue.Position = UDim2.new(0,0,0.4,0); ValBlue.BackgroundTransparency = 1; ValBlue.Text = "0"; ValBlue.TextColor3 = Color3.new(1, 1, 1); ValBlue.Font = Enum.Font.GothamBlack; ValBlue.TextSize = 18; ValBlue.ZIndex=6
...
local TitleRed = Instance.new("TextLabel", BoxRed); TitleRed.Size = UDim2.new(1, 0, 0.3, 0); TitleRed.Position = UDim2.new(0,0,0.1,0); TitleRed.BackgroundTransparency = 1; TitleRed.Text = "Crystals +"; TitleRed.TextColor3 = Settings.Theme.CrystalRed; TitleRed.Font = Enum.Font.GothamBold; TitleRed.TextSize = 12; TitleRed.ZIndex=6
local ValRed = Instance.new("TextLabel", BoxRed); ValRed.Size = UDim2.new(1, 0, 0.5, 0); ValRed.Position = UDim2.new(0,0,0.4,0); ValRed.BackgroundTransparency = 1; ValRed.Text = "0"; ValRed.TextColor3 = Color3.new(1, 1, 1); ValRed.Font = Enum.Font.GothamBlack; ValRed.TextSize = 18; ValRed.ZIndex=6
...
AFKStatus.TextColor3 = Color3.new(0.4, 1, 0.4)
...
local function CreateSlider(parent, title, heb, min, max, default, callback, toggleCallback, toggleName)
    local f = Instance.new("Frame", parent); f.Size = UDim2.new(0.96,0,0,50); f.BackgroundColor3 = Settings.Theme.Box; Library:Corner(f, 8); Library:AddGlow(f, Color3.fromRGB(50,50,50)) -- נמוך (50)
    local l = Instance.new("TextLabel", f); l.Size = UDim2.new(0.7,0,0,20); l.Position = UDim2.new(0,10,0,5); l.Text = title; l.TextColor3=Color3.new(1,1,1); l.Font=Enum.Font.GothamBold; l.TextSize=12; l.TextXAlignment=Enum.TextXAlignment.Left; l.BackgroundTransparency=1
    ...
    if toggleCallback then
        local t = Instance.new("TextButton", f); t.Size = UDim2.new(0,40,0,20); t.Position = UDim2.new(1,-50,0,5); t.BackgroundColor3 = Color3.fromRGB(40,40,40); t.Text = "OFF"; t.TextColor3 = Color3.new(1,1,1); t.Font = Enum.Font.GothamBold; t.TextSize=10; Library:Corner(t,4)
...
local function CreateSquareBind(parent, id, title, heb, default, callback)
    local f = Instance.new("TextButton", parent); local sizeY = id==3 and 45 or 55; 
    ...
    local t = Instance.new("TextLabel", f); t.Size = UDim2.new(1,0,0,15); t.Position = UDim2.new(0,0,0.1,0); t.Text=title; t.TextColor3=Color3.fromRGB(150,150,150); t.Font=Enum.Font.Gotham; t.TextSize=11; t.BackgroundTransparency=1
...
-- CREDITS UPDATED (תיקון הדחיסות + קומפקטי)
...
local function CreateCreditCard(parent, name, role, discord, decal, pos, size)
    ...
    c.Size = size or UDim2.new(0.28, 0, 0, 110) -- כרטיסים צרים יותר אבל מרווחים
    ...
    tRole.Text = role; tRole.TextColor3 = Settings.Theme.IceBlue; tRole.Font=Enum.Font.GothamBold; tRole.TextSize=9; tRole.ZIndex=3
    
    local btn = Instance.new("TextButton", c)
    btn.Size = UDim2.new(0, 70, 0, 18)
    btn.Position = UDim2.new(0.5, -35, 0.88, 0)
...
-- יצירת הכרטיסים - מרווחים יותר (לא דחוסים)
CreateCreditCard(Tab_Credits_Page, "Neho", "Founder", "nx3ho", "97462570733982", UDim2.new(0.05, 0, 0.05, 0)) 
CreateCreditCard(Tab_Credits_Page, "BadShot", "CoFounder", "8adshot3", "133430813410950", UDim2.new(0.67, 0, 0.05, 0))
CreateCreditCard(Tab_Credits_Page, "xyth", "Manager", "sc4rlxrd", "106705865211282", UDim2.new(0.36, 0, 0.35, 0)) -- באמצע למטה
...
local Snowman = Instance.new("TextLabel", SceneContainer); Snowman.Text = "⛄"; Snowman.Size = UDim2.new(0, 40, 0, 40); Snowman.Position = UDim2.new(0.1, 0, 0.45, 0); Snowman.BackgroundTransparency = 1; Snowman.TextSize = 30; Snowman.Rotation = -8; Snowman.ZIndex=4
local Tree1 = Instance.new("TextLabel", SceneContainer); Tree1.Text = "🌲"; Tree1.Size = UDim2.new(0, 50, 0, 50); Tree1.Position = UDim2.new(0.82, 0, 0.35, 0); Tree1.BackgroundTransparency = 1; Tree1.TextSize = 40; Tree1.ZIndex=4
local Tree2 = Instance.new("TextLabel", SceneContainer); Tree2.Text = "🌲"; Tree2.Size = UDim2.new(0, 40, 0, 40); Tree2.Position = UDim2.new(0.72, 0, 0.5, 0); Tree2.BackgroundTransparency = 1; Tree2.TextSize = 30; Tree2.ZIndex=4

--// 9. ניהול מקשים
UIS.InputBegan:Connect(function(i,g)
    if not g then
        if i.KeyCode == Settings.Keys.Menu then if MainFrame.Visible then Library:Tween(MainFrame, {Size = UDim2.new(0,0,0,0)}, 0.3, Enum.EasingStyle.Back); task.wait(0.3); MainFrame.Visible = false else MainFrame.Visible = true; MainFrame.Size = UDim2.new(0, 500, 0, 350); Library:Tween(MainFrame, {Size = UDim2.new(0, 500, 0, 350)}, 0.5, Enum.EasingStyle.Back) end end
...
print("[SYSTEM] Spaghetti Mafia Hub v1 (COMPACT AESTHETIC) Loaded")
